"""
Benchmark magnetic sim with Dask changing number of cells.
"""
...
iterators = (forward_only_values, n_cells_values)
...
for index, (forward_only, n_cells) in enumerate(pool):
    if index > 0:
        print()
    ...
    results.to_netcdf(results_dir / "benchmarks-cells-dask.nc")
